    ...
    ingredient_name = StringField(
        ...
        validators=[
            ...
            Length(
                min=2,
                max=50,
                message="Ingredient name must be between 2 and 50 characters long",
            ),
            Regexp(
                regex=r"^[a-zA-Z0-9\s()\-°]+$",
                message="Ingredient name can only contain letters, numbers, hyphens, parentheses, spaces and degree symbol",
            ),
        ],
    )
